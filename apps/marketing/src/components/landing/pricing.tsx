      ...
      <div className="mx-auto grid max-w-[1400px] gap-12 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
        <div>
          ...
          <h2 className="mt-5 max-w-xl text-balance text-4xl font-bold leading-[0.94] tracking-[-0.04em] text-dunlo-ink md:text-6xl">
            Run the diagnostic free during beta.
          </h2>
          <p className="mt-6 max-w-[62ch] text-pretty text-base leading-7 text-gray-700">
            ...
            Recovery is never enabled by the diagnostic alone.
          </p>
        </div>
        <div className="grid overflow-hidden rounded-2xl bg-white md:grid-cols-[0.78fr_1.22fr]">
          ...
          <ul className="divide-y divide-dunlo-line">
            {PRICING_FEATURES.map((feature) => (
              <li
                key={feature}
                className="flex min-h-16 items-center gap-4 px-6 py-4 text-sm font-semibold text-gray-800"
              >
