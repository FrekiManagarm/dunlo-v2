      ...
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1fr_1.45fr]">
        <div className="max-w-sm">
          ...
          <a
            ...
            className="mt-5 inline-flex size-8 items-center justify-center rounded-full border border-gray-200 text-gray-400 transition-colors hover:border-gray-300 hover:text-gray-700"
