...
description: "Every Stripe payment failure has a reason code. Most SaaS founders ignore them and send the same generic email to everyone. Here's what each failure code means — and exactly what to do about it."
published: true
author: "Dunlo team"
date: "2026-05-22"
...
| `card_velocity_exceed`      | D+1                 | Calm                   | Pause retries 24h           |
