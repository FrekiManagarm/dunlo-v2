---
title: "What Is Dunning in SaaS?"
description: "A plain-English definition of SaaS dunning, why failed subscription payments become involuntary churn, and the core process every founder should understand."
date: "2026-05-14"
published: true
tags: ["dunning", "saas", "definition"]
keywords: ["what is dunning saas", "dunning saas", "automated payment recovery", "involuntary churn"]
---
...
If you are specifically trying to recover Stripe invoices, start with the broader [Stripe failed payments recovery guide](/stripe-failed-payments), then use this article to structure the email sequence.
...
Stripe Smart Retries can help with timing, but it does not explain the failure to the customer. See the [Stripe Smart Retries alternative guide](/stripe-smart-retries-alternative) for where native retries are enough and where dunning emails need to take over.
...
For a Stripe-specific implementation, read the [Stripe dunning workflow guide](/stripe-dunning).
