...
description: "Stripe's built-in dunning recovers some failed payments — but not enough. Learn how to build a dunning process that actually works: the right retry timing, failure-code-specific emails, and when to step in personally."
author: "Dunlo team"
date: "2026-05-22"
published: true
