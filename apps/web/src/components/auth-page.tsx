        ...
        <div className="relative z-10 space-y-10">
          <div>
            ...
            <p className="mt-3 text-sm leading-relaxed text-white/50">
              Expired cards, bank declines, insufficient funds — most of it is
              recoverable if you act on the right failure at the right time.
            </p>
          </div>
          ...
          <ul className="space-y-3">
            {PERKS.map((p) => (
              ...
              >
                <span className="flex size-5 shrink-0 items-center justify-center rounded-full border border-dunlo/30 bg-dunlo/20">
